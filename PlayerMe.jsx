...
Command: npx gltfjsx@6.1.4 D:\Portfolio\Portfolio\public\Models\PlayerMe.glb
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function PlayerMe(props) {
  const { nodes, materials } = useGLTF('/Models/PlayerMe.glb')
  return (
...
useGLTF.preload('/Models/PlayerMe.glb')
