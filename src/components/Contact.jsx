...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_ol89jbk', 'template_tlitkqc', form.current, 'KC-2Ho3L6VQema8t7')
        .then((result) => {
  ...
  return (
    <div id='Contact' className="bg-slate-200 shadow-xl shadow-black">
         <div className="relative ">
        <h1 className=' min-md:relative  text-8xl before:content-["Contactez-moi"] before:text-black before:opacity-5 before:absolute before:top-10 before:left-[0%] before:text-9xl max-sm:text-5xl max-md:before:text-5xl max-sm:before:text-[50px] before:left-25% flex justify-center max-sm:before:bottom-0   '>
          Contact
        </h1>
...
<div class=" bg-white z-50 container my-24 mx-auto md:px-6">
 
  <section class="mb-32">
    <div
      class="relative h-[300px] w-full overflow-hidden opacity-50 bg-cover bg-[100%] bg-no-repeat bg-[url('https://images.pexels.com/photos/804269/pexels-photo-804269.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]">
    </div>
      ...
      <div
        ...
        <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="mx-auto mb-12 text-center lg:mb-0">
            ...
            <h6 class="font-medium">Poitiers,86000</h6>
          </div>
          <div class="mx-auto mb-6 text-center md:mb-0">
            ...
            <h6 class="font-medium">06 18 62 66 62</h6>
          </div>
          ...
          <form  ref={form} onSubmit={sendEmail} >
            <div class="relative mb-6" data-te-input-wrapper-init>
              <input type="text" 
                ...
                id="exampleInput90" placeholder="Name" name="from_name"  />
              <label
            ...
            <button type="submit" value='Send' data-te-ripple-init data-te-ripple-color="light"
              class="inline-block w-full rounded bg-slate-600 px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-black shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-indigo-500  hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] lg:mb-0">
              Envoyé
            </button>
          </form>
        </div>
