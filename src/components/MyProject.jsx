  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className='min-md:relative  text-8xl before:content-["Projets"] before:text-black before:opacity-10 before:absolute before:top-20  before:left-[40%] before:text-7xl max-sm:text-3xl before:text-5xl before:left-10 flex justify-center before:top-0  '>
          Projets
        </h1>
