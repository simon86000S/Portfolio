   ...
   ">
      <div className="flex  ">
        ...
        <ul className=" flex justify-center flex-col text-white ">
          <li className=" relative [clip-path:circle(70%_at_50%_30%)] before:content-[''] before:w-[100px] before:bg-lime-600 before:h-[0px] before:rotate-45 before:absolute  hover:before:h-[1px] hover:before:top-[62px] hover:before:transition-[width]  duration-150 ease-in-out"><a className="relative text-center hover:cursor-pointer " href=''>Accueil</a></li>
