  ...
  return (
    <div className=' relative flex flex-col justify-center items-center  z-50 min-md:relative  text-8xl before:content-["Qui-suis-je"] before:text-black before:opacity-5 before:absolute before:top-10 before:left-[30%] before:text-9xl max-sm:text-5xl max-md:before:text-5xl max-sm:before:text-[50px] before:left-25% flex justify-center max-sm:before:bottom-0    '>
      ...
      <p className="  max-w-md text-xl p-10 leading-8  text-justify text-center  ">
        ...
        J'ai acquis une connaissance dans différents languages de programmation,
        ...
        <br />
        Je conçois et réalise des sites web et{" "}
        <strong>application web mobile.</strong>
        <br />
        N'hésitez pas à voir mon CV au format pdf:{" "}
        <a
          className=" p-1.5 bg-black  text-white  hover:text-gray-500 rounded-md"
          href={CV}
          download
        >
          Mon CV
