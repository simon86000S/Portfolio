...
const Presentation = () => {
  return (
    <div className='flex flex-col justify-center items-center  z-50 '>
       ...
       <p className='  max-w-md text-xl p-10 leading-8  text-justify text-center  '>En tant que développeur web depuis plus de 3 ans, je suis passionné par la création de sites web et d'application mobile. J'ai acquis une connaissance dans différents languages de programmation, ainsi que dans l'utilisation de frameworks populaires tels que ViteJs et NextJs.
